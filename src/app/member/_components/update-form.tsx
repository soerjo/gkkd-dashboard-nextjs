...
export const UpdateFormInput = ({
    ...
    React.useEffect(() => {
        reset({
            ...payload,
            phone_number: payload?.phone_number || "",  // Default to empty string if undefined
            address: payload?.address || "",
            father_name: payload?.father_name || "",
            mother_name: payload?.mother_name,
            birth_order: payload?.birth_order || undefined,
            total_brother_sister: payload?.total_brother_sister || undefined,
            marital_status: payload?.marital_status || undefined,
            husband_wife_name: payload?.husband_wife_name || "",
            wedding_date: payload?.wedding_date || "",
            // region_service: payload?.region_service,
    ...
    return (
        ...
        >
            ...
            <Form {...form}>
                ...
                >
                    <ScrollArea className={`w-full rounded-md p-2 h-[78vh]`}>
