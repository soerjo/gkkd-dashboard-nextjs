  ...
  return (
    <ResponsiveContainer width='100%' height={350}>
      <AreaChart data={data} >
        ...
        />
        <Tooltip />
        <Area type="monotone" dataKey="sundah_service" stroke="#8884d8" fillOpacity={1} fill="url(#sundah_service)" />
        <Area type="monotone" dataKey="blesscomn" stroke="#82ca9d" fillOpacity={1} fill="url(#blesscomn)" />
        <Area type="monotone" dataKey="desciple" stroke="#FB8500" fillOpacity={1} fill="url(#desciple)" />
